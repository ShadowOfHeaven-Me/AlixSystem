package shadow.systems.metrics;
...
public final class Metrics {
    ...
    public static Metrics createMetrics() {
        //metrics.addCustomChart(new Metrics.SimplePie("chart_id", () -> "My value")); // <- chuj wie co to robi
        return new Metrics(Main.plugin, 18945);
    }
