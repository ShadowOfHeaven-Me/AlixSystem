...
public final class ReCaptcha extends Captcha {
    ...
    private static final ConstLocation SPAWN_LOC = AlixWorld.TELEPORT_LOCATION.asModifiableCopy().add(1, 0, -1.5).toConst();
    public static final ConstLocation HEAD_LOC = SPAWN_LOC.asModifiableCopy().add(0, 1.75, 0).toConst();
    private final ByteBuf[] buffers;

    public ReCaptcha() {
        this.buffers = ImageRenderer.recaptcha(SPAWN_LOC);
    }
