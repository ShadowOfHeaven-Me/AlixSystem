...
/*    private static final List<ItemStack>
    ...
    public VirtualAuthBuilder(AlixUser user, Consumer<Boolean> onConfirm, boolean includeLeaveButton) {
        ...
        this.hexSecretKey = GoogleAuthUtils.getHexKey(UserTokensFileManager.getTokenOrSupply(MapSecretKey.uuidKey(user.reetrooperUser().getUUID()), GoogleAuthUtils::generateSecretKey));
        this.gui.setSpoofWithCached(true);
    }
