...
public class NbtMessageUtil {
    ...
    public static NbtMessage fromLiteral(String message) {
        String json = "{\"text\":\"" + message +  "\"}";
        return create(json);
    }

    public static NbtMessage create(String json) {
        BinaryTag compoundBinaryTag = fromJson(new JsonParser().parse(json));
    ...
    public static BinaryTag fromJson(JsonElement json) {
        ...
        } else if (json instanceof JsonArray) {//new NonNullElementWrapperList<>()
