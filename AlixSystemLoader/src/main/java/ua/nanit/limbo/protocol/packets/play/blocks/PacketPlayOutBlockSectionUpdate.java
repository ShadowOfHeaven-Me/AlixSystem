...
public final class PacketPlayOutBlockSectionUpdate extends OutRetrooperPacket<WrapperPlayServerMultiBlockChange> {
    ...
    public static PacketPlayOutBlockSectionUpdate packetToSpoof(Vector3i pos, StateType type, ClientVersion clientVersion) {
        return packetsToSpoof(Map.of(pos, type), clientVersion).get(0);
    }
