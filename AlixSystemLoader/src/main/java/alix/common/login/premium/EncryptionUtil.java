...
public final class EncryptionUtil {
    ...
    public static byte[] generateVerifyToken() {
        return generateVerifyToken(random);
    }
    ...
    public static boolean verifyClientKey(ClientPublicKey clientKey, Instant verifyTimestamp, UUID premiumId) throws Exception {
    ...
    public static boolean verifyNonce(byte[] expected, PrivateKey decryptionKey, byte[] encryptedNonce) throws Exception {
