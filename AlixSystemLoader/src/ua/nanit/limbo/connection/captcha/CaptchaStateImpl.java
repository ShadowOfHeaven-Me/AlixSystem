...
import alix.libs.com.github.retrooper.packetevents.protocol.player.InteractionHand;
...
import ua.nanit.limbo.connection.captcha.blocks.CaptchaBlock;
import ua.nanit.limbo.connection.captcha.blocks.CaptchaBlockCheck;
...
final class CaptchaStateImpl {
    ...
    private boolean movementsSent, pongReceived;
    ...
    void handle(WrapperPlayClientPong ping) {
        ...
        CaptchaBlock block = CaptchaBlockCheck.sendRandomBlock(this.connection, pos);

        this.expectedYCollision = blockY + block.getHeight(this.version());
    ...
    private boolean isFalling, isCheckingCollision, checkedCollision, isAwaitingTransaction;
    ...
    private void scheduledKickTask() {
